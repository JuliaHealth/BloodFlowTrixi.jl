struct BloodFlowEquations1DOrd2{E} <:
       Trixi.AbstractEquationsParabolic{1,4,GradientVariablesConservative}
    model1d::E
end
...
@inline function (boundary_condition::Trixi.BoundaryConditionNeumann)(
    flux_inner,
    u_inner,
    orientation_or_normal,
    direction,
