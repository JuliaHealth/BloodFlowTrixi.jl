...
function get3DData(
    ...
    vtk::Bool=false,
    out::T="./datas",
) where {T<:AbstractString,F1<:Function,F2<:Function}
    ...
    Pval = map(
        (a, Qth, Qs, E, A0)->BloodFlowTrixi.pressure(SA[a, Qth, Qs, E, A0], eq),
        aval,
        Qthval,
        Qsval,
        Eval,
...
function get3DData(
    ...
    vtk::Bool=false,
    out::T="./datas",
) where {T<:AbstractString,F1<:Function,F2<:Function,F3<:Function}
    ∧(v, w) = SA[
